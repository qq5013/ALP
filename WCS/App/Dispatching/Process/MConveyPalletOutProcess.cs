...
namespace App.Dispatching.Process
{
    ...
    /// 空托盤出庫口
    /// </summary>
    public class MConveyPalletOutProcess : AbstractProcess
    {
        ...
        protected override void StateChanged(StateItem stateItem, IProcessDispatcher dispatcher)
        {
            ...
            {
                Logger.Error("MConveyPalletOutProcess出現錯誤，錯誤原因：" + ex.Message);
            }
        ...
        private void tmWorker(object sender, ElapsedEventArgs e)
        {
            ...
            {
                tmWorkTimer.Stop();
                DataParameter[] paras = new DataParameter[] { new DataParameter("{0}", string.Format("(TaskType='11' and Flag=5 or TaskType='99') and State=0 and AreaCode='ML'")) };
                BLL.BLLBase bllStock = new BLL.BLLBase("StockDB");
            ...
            {
                Logger.Error("MConveyPalletOutProcess中tmWorker出現錯誤，錯誤原因：" + ex.Message);
            }
            finally
            {
