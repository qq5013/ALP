...
namespace App.Dispatching.Process
{
    ...
    /// 空托盤移動完成
    /// </summary>
    public class ConveyPickProcess : AbstractProcess
    {
        ...
        protected override void StateChanged(StateItem stateItem, IProcessDispatcher dispatcher)
        {
            ...
            try
            {
                ...
                DataTable dtMiddle = bllMiddle.FillDataTable("Middle.SelectConveyMoveTask", new DataParameter[] { new DataParameter("@Device", "UL"), new DataParameter("{0}", string.Format("main.task_id={0} and hu_id='{1}' and subtask_id!={1}", TaskID, PalletCode, SubTaskID)) });
                ...
                {
                    Logger.Error("ConveyInStockProcess中找不到棧板："+ PalletCode+" 的後續處理方式！");
                }
